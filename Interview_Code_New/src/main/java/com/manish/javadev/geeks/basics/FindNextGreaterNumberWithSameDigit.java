 ...
 * For example: if the input number is 534976, we stop at 4 because 4 is smaller
 * than next digit 9. 
 ...
 * greater than. For 534976, the right side of 4 contains 976. The
 * smallest digit greater than 4 is 6.
 * 
 * III) Swap the above found two digits, we get 536974 in above example.
 * 
 * IV) Now sort all digits from position next to the end of number. The
